...
const rightFrameEndpoints = {
  ...
  fights: (fighter_id, year) => `section-right/get-fight-count/?fighter_id=${fighter_id}&year=${year.join(",")}`,
...
const leftFrameEndpoints = {
  metrics: (fight_date, fighter_id, action_name_id) =>
    `section-left/metrics/?fight_date=${fight_date}&action_name_id=${action_name_id}&fighter_id=${fighter_id}`,
};
