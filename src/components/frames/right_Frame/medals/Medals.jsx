                            ...
                            Data.map((item) => {
                                ...
                                return (
                                    <div key={item.id} className='flex flex-col items-center justify-center '>
                                        <p className={`text-${item.type === 'Gold' ? '[#FCC417]' : item.type === 'Silver' ? '[#CECDD2]' : '[#F79429]'} pb-1`}>{item.type}</p>
                                        ...
                                        medals?.gold_place?.map((item, i) => {
                                            ...
                                            return (
                                                <div className='flex items-center justify-between px-5 text-center w-full py-1 gap-4' key={i}>
                                                    ...
                                                    <p className='text-sm truncate-none truncate hover:scale-150 z-10'>{item?.location}</p>
                                                </div>
                                            );
                                        })
                                    ) : (
