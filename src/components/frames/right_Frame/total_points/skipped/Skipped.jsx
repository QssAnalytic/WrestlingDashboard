...
const Skipped = () => {
    return (
        <div>
            <div className='w-[303px] h-[88px] bg-[#121319] rounded border border-[#ED2939] flex justify-center items-center'>
                <div className='h-full w-full flex justify-center items-center flex-col'>
                    <span className='text-2xl text-[#ED2939]  w-[72px]  h-[37px] border border-[#2B2D33] bg-[#21232A] rounded py-1 mt-2 px-[18px] flex justify-center items-center'>  2.1</span>
